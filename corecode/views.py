...
from .forms import SubjectForm, StudentClassForm, AcademicTermForm, AcademicSessionForm, SiteConfigForm, CurrentSessionForm
...
class ClassCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    success_message = 'New classes successfully added'
...
class ClassUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    ...
    fields = ['name']
    success_url = reverse_lazy('classes')
    success_message = 'Classes successfully updated.'
    template_name = 'corecode/mgt_form.html'
